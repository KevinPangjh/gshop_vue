<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowInfo=true">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">{{info.distance}}</span>
        </div>
        <p class="shop-notice">是以粥为特色的中式营养快餐，自2004年10月18日创立“嘉和一品”品牌至今</p>
      </div>
    </div>
    <div class="shop-header-discounts" @click="isShowActive=true" v-if="info.supports">
