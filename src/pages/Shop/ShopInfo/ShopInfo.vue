  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="classSelect[support.type]" v-for="(support,index) in info.supports" :key="index">
...
<script>
  ...
  export default {
    data(){
      return{
        classSelect:['activity-green','activity-red','activity-orange']
      }
    },
    computed:{
      ...mapState(['info'])
    ...
    methods:{
      _initScroll(){
        ...
        const imgUl= this.$refs.imgUl
        const liWidth= 120
        const space= 6
        const count= this.info.pics.length
        imgUl.style.width = (liWidth + space) * count - space + 'px'
